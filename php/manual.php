		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-7">
					<div class="container-fluid">
						<div class="row">
							<select id="user" class="combobox form-control">
		  						<option>Customer Name ...</option>
		  						<?php for($i=0;$i<count($names);$i++){ ?>
		  						<option value="<?php echo $i ?>"><?php echo $names[$i]?></option>
		  						<?php }?>
							</select>
						</div>
	...
	var exampleSocket = new WebSocket("ws://127.0.0.1:8080");
		...
		function myfun(price,name)
		{
			...
			else
			{
				...
				newElement.setAttribute("class","mimi");
		...
		function send()
		{
			...
			//console.log(str);
			if(roomno!="Select Room"&&name!="Customer Name ...")
			{
				alert("your order had been sent");
	 ...
	 // exampleSocket.send("Here's some text that the server is urgently awaiting!"); 
		               ...
		               // exampleSocket.send("order"+","+r.date+","+name+","+roomno+","+r.status+","+r.order_id+","+r.product+","+r.price+","+r.image);
		            }
				}
	    		...
	    		//var rem=document.getElementsByClassName("mimi");
	    		//console.log(rem);
